...
<c:url value="/download/proquiz.apk" var="apkUrl" />
...
<div class="col-xl-7 col-lg-12 col-md-12 col-sm-12 left">
    ...
    <!-- 
     <div class="btns">
      <a class="btn btn-download col-xl-10 col-lg-12 col-md-12 col-sm-12 pt-2" href="${apkUrl}" download="proquiz"><i class="fa fa-download"></i> Завантажити Android додаток</a>
    </div>
     -->
</div>
